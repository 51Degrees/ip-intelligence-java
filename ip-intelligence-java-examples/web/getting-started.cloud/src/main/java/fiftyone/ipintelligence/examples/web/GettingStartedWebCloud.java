...
import static fiftyone.ipintelligence.examples.shared.KeyHelper.getOrSetTestResourceKey;
...
public class GettingStartedWebCloud extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            doIPIntelligenceData(out, device, flowData, null);
 ...
 *
 * This example is available in full on [GitHub](https://github.com/51Degrees/ip-intelligence-java-examples/blob/master/web/getting-started.cloud/src/main/java/fiftyone/devicedetection/examples/web/GettingStartedWebCloud.java).
 *
 * @include{doc} example-require-resourcekey.txt
 *
 * ## Overview
 *
 * The `PipelineFilter` to intercept requests and perform IP Intelligence. The results will be
