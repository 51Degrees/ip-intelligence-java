...
/**
 * The example illustrates the various metrics that can be obtained about the IP Intelligence
    ...
    static void run(String dataFile, List<Map<String, String>> evidenceList,
        ...
        try (Pipeline pipeline = new DeviceDetectionPipelineBuilder()
            ...
            try (FlowData data = pipeline.createFlowData()) {
                ...
                IPIntelligenceDataHash device = data.get(IPIntelligenceDataHash.class);
                ...
                String hashEngineElementKey =
                        pipeline.getElement(IPIntelligenceOnPremiseEngine.class).getElementDataKey();
 ...
 * page.
 * # Location
 * This example is available in full on [GitHub](https://github.com/51Degrees/ip-intelligence-java-examples/blob/master/console/src/main/java/fiftyone/devicedetection/examples/console/MatchMetrics.java).
 *
 */
