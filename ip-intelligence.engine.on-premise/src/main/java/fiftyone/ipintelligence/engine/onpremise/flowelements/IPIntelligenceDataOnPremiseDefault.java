...
/**
 * Internal implementation of the {@link IPIntelligenceDataOnPremise} interface.
 * This can only be constructed by the {@link IPIntelligenceOnPremiseEngine}.
...
public class IPIntelligenceDataOnPremiseDefault
     ...
     */
    IPIntelligenceDataOnPremiseDefault(
        Logger logger,
        FlowData flowData,
    ...
    private void checkState() {
        if (closed) {
            throw new IllegalStateException("The IPIntelligenceDataOnPremise instance has " +
        ...
        for (ResultsIpiSwig result : resultsList) {
            try {
                ...
                logger.error("Failed to close native results instance. " +
                    "An IPIntelligenceDataOnPremise instance contains native unmanaged " +
