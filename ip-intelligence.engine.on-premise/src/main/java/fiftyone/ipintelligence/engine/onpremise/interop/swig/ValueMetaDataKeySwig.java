...
public class ValueMetaDataKeySwig {
  ...
  public ValueMetaDataKeySwig(String propertyName, String valueName) {
    this(IpIntelligenceOnPremiseEngineModuleJNI.new_ValueMetaDataKeySwig__SWIG_0(propertyName, valueName), true);
  }

  public ValueMetaDataKeySwig(String propertyName, byte[] data) {
    this(IpIntelligenceOnPremiseEngineModuleJNI.new_ValueMetaDataKeySwig__SWIG_1(propertyName, data), true);
  }
