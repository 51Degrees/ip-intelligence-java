...
public class HardwareProfileCloudEngineBuilder extends AspectEngineBuilderBase<
    ...
    protected HardwareProfileCloudEngine newEngine(List<String> properties) {
        return new HardwareProfileCloudEngine(
            ...
            new ElementDataFactory<MultiIPIDataCloud>() {
                @Override
                public MultiIPIDataCloud create(FlowData flowData, FlowElement<MultiIPIDataCloud, ?> flowElement) {
                    return new MultiIPIDataCloud(
                        loggerFactory.getLogger(MultiIPIDataCloud.class.getSimpleName()),
                        flowData,
                        (AspectEngine<MultiIPIDataCloud, ?>) flowElement,
